/* ============================================================
   WAR DESK v2.3 — VOD (Stremio via Cinemeta)
   - v2.3: User-feedback bij fouten (toast)
   - v2.2: Skeletons worden verwijderd vóór items
   ============================================================ */
...
(function(){
  ...
  console.log("[WAR DESK] vod-v23.js v2.3 geladen");
})();