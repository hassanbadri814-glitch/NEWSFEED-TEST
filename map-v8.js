...
(function(){
  ...
  /* ============================================================
     v8: fetchEvents met retry-mechanisme + alle proxies
     ============================================================ */
  async function fetchEvents(retryCount){
    ...
    /* Alle proxies faalden — retry na korte pauze */
    if(retryCount < 2){
  ...
  /* ============================================================
     v8: activateMapView opent NIET meer in fullscreen
     ============================================================ */
  function activateMapView(){
    initMap();
    ensureFullscreenClose();
    /* v8: automatische fullscreen verwijderd — gebruiker klikt zelf op ⛶ */
