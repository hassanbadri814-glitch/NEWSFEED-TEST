/* ============================================================
   WAR DESK v1.0 — Centrale Storage Module
...
window.WDStorage = (function(){
  ...
  var KEYS = {
    ...
    active_tab:          "wardesk_active_tab",       // sessionStorage
  ...
  /* ===== Debug: overzicht van opgeslagen waarden ===== */
  function dump(){
    var out = {};
    Object.keys(KEYS).forEach(function(k){
      try{
...
// Log: alleen in debug-modus
if(window.WD_DEBUG){
  try{ console.log("[WAR DESK] storage.js v1.0 geladen — " + Object.keys(window.WDStorage.KEYS).length + " keys"); }catch(e){}
}